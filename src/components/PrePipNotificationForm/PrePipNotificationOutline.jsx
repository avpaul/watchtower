...
const PrePipNotificationOutline = ({ fellowFeedback, serialNumber }) => {
  ...
  return (
    <div className="prepipForm" id="prepipForm">
      ...
      <p className="prepipHtml">
        The purpose of this email is to notify you that your performance has
        been and is currently not at a satisfactory level. As such, you are
        required to level up on the following skills/areas within the coming
        weeks:
      </p>
